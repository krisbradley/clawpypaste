...
<dict>
    ...
    <string>clawpypaste needs to control your terminal to paste dropped files into your Claude Code prompt and to run shell commands in a new Terminal window.</string>
